        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-8 mb-8 border border-gray-100 flex flex-col md:flex-row justify-between items-center relative overflow-hidden">
                ...
                <div id="aunardo-container" class="relative flex flex-col items-center justify-center p-4 mt-6 md:mt-0 cursor-pointer group z-20" title="¡Haz clic en Aunardo!">
                    ...
                    <span class="text-[11px] font-bold text-[#0b2545] mt-2 bg-yellow-300 px-3 py-0.5 rounded-full shadow-sm">¡Haz clic aquí!</span>
                </div>
            </div>

            <!-- SECCIÓN: MÓDULOS PRINCIPALES CON EFECTO DE SONIDO -->
            <div class="mb-8">
