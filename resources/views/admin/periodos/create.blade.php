        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl rounded-2xl border border-gray-100 p-8">
                ...
                <div class="mb-6 border-b pb-4">
                    ...
                    <h2 class="text-xl font-bold text-slate-800 mt-1">Crear Nuevo Periodo Académico</h2>
                    <p class="text-sm text-slate-500">Configura los detalles del nuevo semestre o periodo lectivo.</p>
                </div>
                ...
                <form method="POST" action="{{ route('admin.periodos.store') }}" class="space-y-5">
                    @csrf
                    ...
                    <div>
                        ...
                        <select name="periodo" required class="w-full px-4 py-2.5 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-[#0b2545] text-sm">
                            ...
                            <option value="Periodo Especial">Periodo Especial / Vacacional</option>
                        </select>
                    </div>

                    <div>
                        <label class="block text-xs font-bold uppercase tracking-wider text-slate-600 mb-1.5">Año (Vigencia) *</label>
                        <input type="number" name="anio" value="{{ date('Y') }}" required min="2024" max="2035"
