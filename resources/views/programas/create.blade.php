<x-app-layout>
    <x-slot name="header">
        <h2 class="font-black text-xl text-[#0b2545] leading-tight">
            {{ __('Crear Nuevo Programa Académico') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 p-8">
                ...
                <div class="border-b border-gray-100 pb-4 mb-6">
                    ...
                    <h3 class="text-2xl font-black text-[#0b2545] mt-2">Registrar Programa Académico</h3>
                </div>
                ...
                <form action="{{ route('admin.programas.store') }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="codigo" id="codigo" value="{{ old('codigo') }}" placeholder="Ej: 102519" class="block w-full rounded-xl border-gray-200 shadow-sm focus:border-[#0b2545] focus:ring-[#0b2545] text-sm py-3" required>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="nombre" id="nombre" value="{{ old('nombre') }}" placeholder="Ej: Administración De Empresas" class="block w-full rounded-xl border-gray-200 shadow-sm focus:border-[#0b2545] focus:ring-[#0b2545] text-sm py-3" required>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <select name="facultad" id="facultad" class="block w-full rounded-xl border-gray-200 shadow-sm focus:border-[#0b2545] focus:ring-[#0b2545] text-sm py-3" required>
                            ...
                            <option value="Ciencias administrativas y contables" {{ old('facultad') == 'Ciencias administrativas y contables' ? 'selected' : '' }}>Ciencias administrativas y contables</option>
                            <option value="Ciencias aplicadas y de la salud" {{ old('facultad') == 'Ciencias aplicadas y de la salud' ? 'selected' : '' }}>Ciencias aplicadas y de la salud</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="number" name="plan_estudios" id="plan_estudios" value="{{ old('plan_estudios') }}" placeholder="Ej: 2" class="block w-full rounded-xl border-gray-200 shadow-sm focus:border-[#0b2545] focus:ring-[#0b2545] text-sm py-3" required>
                    </div>
